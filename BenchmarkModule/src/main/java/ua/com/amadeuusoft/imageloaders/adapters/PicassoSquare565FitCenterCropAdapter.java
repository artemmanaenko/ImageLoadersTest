 ...
 */
public class PicassoSquare565FitCenterCropAdapter extends BaseBenchmarkAdapter {

    private Config565Transformation transformation = new Config565Transformation();

    public PicassoSquare565FitCenterCropAdapter(Context context, IUrlListContainer urlListContainer) {
