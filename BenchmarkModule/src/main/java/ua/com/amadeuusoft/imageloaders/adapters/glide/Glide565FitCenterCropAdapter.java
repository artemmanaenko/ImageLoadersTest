 ...
 */
public class Glide565FitCenterCropAdapter extends BaseBenchmarkAdapter {

    private GlideConfig565Transformation transformation = new GlideConfig565Transformation();

    public Glide565FitCenterCropAdapter(Context context, IUrlListContainer urlListContainer) {
