 ...
 */
public class Picasso565FitCenterCropAdapter extends BaseBenchmarkAdapter {

    private Config565Transformation transformation = new Config565Transformation();

    public Picasso565FitCenterCropAdapter(Context context, IUrlListContainer urlListContainer) {
